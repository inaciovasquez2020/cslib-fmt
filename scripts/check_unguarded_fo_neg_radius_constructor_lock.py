...
ART = Path("artifacts/cslib_fmt/unguarded_fo_neg_radius_constructor_lock_2026_06_20.json")
DOC = Path("docs/status/UNGUARDED_FO_NEG_RADIUS_CONSTRUCTOR_LOCK_2026_06_20.md")
LEAN = Path("lean/CSLIB/FMT/UnguardedFO/LocalityInputSurface.lean")

EXPECTED_STATUS = "UNGUARDED_FO_NEG_RADIUS_CONSTRUCTOR_LOCK_ONLY"

REQUIRED_LEAN_MARKERS = [
    "theorem unguarded_fo_neg_radius_constructor",
...
def main() -> None:
    ...
    assert artifact["object"] == "unguarded_fo_neg_radius_constructor"
    assert artifact["lean_file"] == str(LEAN)

    theorem_pos = lean.index("theorem unguarded_fo_neg_radius_constructor")
    ...
    print("UNGUARDED_FO_NEG_RADIUS_CONSTRUCTOR_LOCK_OK")

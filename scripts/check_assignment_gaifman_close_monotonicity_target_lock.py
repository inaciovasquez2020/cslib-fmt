...
ART = Path("artifacts/cslib_fmt/assignment_gaifman_close_monotonicity_target_lock_2026_06_20.json")
DOC = Path("docs/status/ASSIGNMENT_GAIFMAN_CLOSE_MONOTONICITY_TARGET_LOCK_2026_06_20.md")
LEAN = Path("lean/CSLIB/FMT/UnguardedFO/LocalityInputSurface.lean")

EXPECTED_STATUS = "ASSIGNMENT_GAIFMAN_CLOSE_MONOTONICITY_TARGET_LOCK_ONLY"

REQUIRED_LEAN_MARKERS = [
    "structure AssignmentGaifmanCloseMonotonicityTarget",
...
def main() -> None:
    ...
    assert artifact["object"] == "AssignmentGaifmanCloseMonotonicityTarget"
    assert artifact["lean_file"] == str(LEAN)

    structure_pos = lean.index("structure AssignmentGaifmanCloseMonotonicityTarget")
    ...
    print("ASSIGNMENT_GAIFMAN_CLOSE_MONOTONICITY_TARGET_LOCK_OK")

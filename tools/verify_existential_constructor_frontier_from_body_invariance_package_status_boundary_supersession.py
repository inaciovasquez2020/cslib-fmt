...
DOC = Path("docs/status/EXISTENTIAL_CONSTRUCTOR_FRONTIER_FROM_BODY_INVARIANCE_PACKAGE_STATUS_BOUNDARY_SUPERSESSION.md")
ARTIFACT = Path("artifacts/existential_constructor_frontier_from_body_invariance_package_status_boundary_supersession_2026_06_22.json")
HISTORICAL_ARTIFACT = Path("artifacts/existential_constructor_frontier_from_body_invariance_package_status_2026_06_21.json")
HISTORICAL_DOC = Path("docs/status/EXISTENTIAL_CONSTRUCTOR_FRONTIER_FROM_BODY_INVARIANCE_PACKAGE_STATUS.md")
...
for marker in [
    "STATUS := EXISTENTIAL_CONSTRUCTOR_FRONTIER_FROM_BODY_INVARIANCE_PACKAGE_STATUS_BOUNDARY_SUPERSESSION_ONLY",
    "SOURCE_HISTORICAL_ARTIFACT := artifacts/existential_constructor_frontier_from_body_invariance_package_status_2026_06_21.json",
    "SOURCE_HISTORICAL_DOC := docs/status/EXISTENTIAL_CONSTRUCTOR_FRONTIER_FROM_BODY_INVARIANCE_PACKAGE_STATUS.md",
    "WEAKEST_NEXT_BOUNDARY := next_historical_missing_constructor_record_supersession",
]:
    assert marker in doc, marker

assert artifact["status"] == "EXISTENTIAL_CONSTRUCTOR_FRONTIER_FROM_BODY_INVARIANCE_PACKAGE_STATUS_BOUNDARY_SUPERSESSION_ONLY"
assert artifact["source_historical_artifact"] == "artifacts/existential_constructor_frontier_from_body_invariance_package_status_2026_06_21.json"
assert artifact["source_historical_doc"] == "docs/status/EXISTENTIAL_CONSTRUCTOR_FRONTIER_FROM_BODY_INVARIANCE_PACKAGE_STATUS.md"
...
print("EXISTENTIAL_CONSTRUCTOR_FRONTIER_FROM_BODY_INVARIANCE_PACKAGE_STATUS_BOUNDARY_SUPERSESSION_OK")

...
DOC = Path("docs/status/EXISTENTIAL_BODY_DISTINCT_WITNESS_ASSIGNMENT_EXTENSION_INVARIANCE_BOUNDARY_SUPERSESSION.md")
ARTIFACT = Path("artifacts/existential_body_distinct_witness_assignment_extension_invariance_boundary_supersession_2026_06_22.json")
HISTORICAL_ARTIFACT = Path("artifacts/existential_body_distinct_witness_assignment_extension_invariance_2026_06_21.json")
HISTORICAL_DOC = Path("docs/status/EXISTENTIAL_BODY_DISTINCT_WITNESS_ASSIGNMENT_EXTENSION_INVARIANCE.md")
...
for marker in [
    "STATUS := EXISTENTIAL_BODY_DISTINCT_WITNESS_ASSIGNMENT_EXTENSION_INVARIANCE_BOUNDARY_SUPERSESSION_ONLY",
    "SOURCE_HISTORICAL_ARTIFACT := artifacts/existential_body_distinct_witness_assignment_extension_invariance_2026_06_21.json",
    "SOURCE_HISTORICAL_DOC := docs/status/EXISTENTIAL_BODY_DISTINCT_WITNESS_ASSIGNMENT_EXTENSION_INVARIANCE.md",
    "WEAKEST_NEXT_BOUNDARY := next_historical_missing_constructor_record_supersession",
]:
    assert marker in doc, marker

assert artifact["status"] == "EXISTENTIAL_BODY_DISTINCT_WITNESS_ASSIGNMENT_EXTENSION_INVARIANCE_BOUNDARY_SUPERSESSION_ONLY"
assert artifact["source_historical_artifact"] == "artifacts/existential_body_distinct_witness_assignment_extension_invariance_2026_06_21.json"
assert artifact["source_historical_doc"] == "docs/status/EXISTENTIAL_BODY_DISTINCT_WITNESS_ASSIGNMENT_EXTENSION_INVARIANCE.md"
...
assert "existential_body_distinct_witness_assignment_extension_invariance" in artifact["current_lean_objects"]
assert "existential_body_assignment_extension_invariance_component_package" in artifact["current_lean_objects"]
...
print("EXISTENTIAL_BODY_DISTINCT_WITNESS_ASSIGNMENT_EXTENSION_INVARIANCE_BOUNDARY_SUPERSESSION_OK")

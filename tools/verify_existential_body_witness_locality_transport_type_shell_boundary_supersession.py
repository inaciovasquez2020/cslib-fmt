...
DOC = Path("docs/status/EXISTENTIAL_BODY_WITNESS_LOCALITY_TRANSPORT_TYPE_SHELL_BOUNDARY_SUPERSESSION.md")
ARTIFACT = Path("artifacts/existential_body_witness_locality_transport_type_shell_boundary_supersession_2026_06_22.json")
HISTORICAL_ARTIFACT = Path("artifacts/existential_body_witness_locality_transport_type_shell_2026_06_21.json")
HISTORICAL_DOC = Path("docs/status/EXISTENTIAL_BODY_WITNESS_LOCALITY_TRANSPORT_TYPE_SHELL.md")
...
for marker in [
    "STATUS := EXISTENTIAL_BODY_WITNESS_LOCALITY_TRANSPORT_TYPE_SHELL_BOUNDARY_SUPERSESSION_ONLY",
    "SOURCE_HISTORICAL_ARTIFACT := artifacts/existential_body_witness_locality_transport_type_shell_2026_06_21.json",
    "SOURCE_HISTORICAL_DOC := docs/status/EXISTENTIAL_BODY_WITNESS_LOCALITY_TRANSPORT_TYPE_SHELL.md",
    "WEAKEST_NEXT_BOUNDARY := next_historical_missing_constructor_record_supersession",
]:
    assert marker in doc, marker

assert artifact["status"] == "EXISTENTIAL_BODY_WITNESS_LOCALITY_TRANSPORT_TYPE_SHELL_BOUNDARY_SUPERSESSION_ONLY"
assert artifact["source_historical_artifact"] == "artifacts/existential_body_witness_locality_transport_type_shell_2026_06_21.json"
assert artifact["source_historical_doc"] == "docs/status/EXISTENTIAL_BODY_WITNESS_LOCALITY_TRANSPORT_TYPE_SHELL.md"
...
print("EXISTENTIAL_BODY_WITNESS_LOCALITY_TRANSPORT_TYPE_SHELL_BOUNDARY_SUPERSESSION_OK")

...
Portfolio class: **PROOF_FACING**

Role:

Proof-facing support library candidate. Small nonvacuous Lean content; not a major theorem proof.
...
This repository may be presented as proof-facing only within its stated theorem limits.
...
`cslib-fmt` is a proof-facing Lean artifact subject to its explicit in-repository boundaries.
